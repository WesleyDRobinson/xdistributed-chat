    ...
    render() {
        return this.html`
            ...
            <div class="pl4 pb5 center mw7 z-0 bg-washed-green">
                ...
                <h2 id="why-do-i-want-distributed-chat" class="dib mb0 pa2 dark-green bg-washed-green athelas tj ttu lh-title">How do I use this?</h2>
                ...
                <h2 id="how-is-distributed-chat-different" class="dib mv0 pa2 dark-green bg-washed-green athelas ttu">How is this different from SMS or email or Slack?</h2>
                    ...
                    <ul class="list pl2">
                        ...
                        <li class="mb2">⏳<span class="i f4">Realtime only</span>: messages are broadcast <span class="b">only once</span> to the currently connected peers; new peers entering the room will not &quot;catch up," aka forward secrecy</li>
                ...
                <h2 id="why-do-i-want-distributed-chat" class="dib mb0 pa2 dark-green bg-washed-green athelas ttu lh-title">Why do I want this?</h2>
                    <article class="pa2 lh-copy">                
                        <p>You might not! It's a brittle means of communication. But it is a pretty tool as far as I can tell.</p>
                        <p>It is a free-to-use and powerful browser-based communication tool.</p> 
